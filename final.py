...
def main():
    # expr = '[1234567890]+'
    # expr = '(\\a|\\d)+.(\\a)+.(com|net|org)'
    expr = '../(..|\\a+)/\\d+'
    string = 'My birthday is on 12/jan/2001'
...
# $ Ends with               (whole string)
# * Zero or more occurrences               (exceeding preceding one alphabet in whole string)
# + One or more occurrences               (whole string)
# {} Exactly the specified number of occurrences               (whole string)
# | Either or               (whole string)
# () Capture and group               (whole string)